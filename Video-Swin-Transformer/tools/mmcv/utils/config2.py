import sys
sys.path.insert(0, '/home/s3/joonhaki/FQ-ViT')
...
class Config2:
    ...
    def __init__(self, ptf=True, lis=True, quant_method='minmax'):
        ...
        ##Quantization experiments configuration!!!
        self.act_dequant=False
        self.act_quant_layer=[False,False,False, False]
        self.input_quant = False
        self.print_model=False
        self.print_modulist=False
        self.lis = lis